...
#Modeling --- Blocs code that are less relevant or more time consuming are put in comment
  ...
  #xgbTree model - other tunning parameters - hidden as not best
    ...
    # RMSE_xgbTree_other <- RMSE(test_set_scaled$Value, y_hat_Value_other_xgbTree)
    # WMAPE_xgbTree_other <- WMAPE(test_set_scaled$Value, y_hat_Value_other_xgbTree)
